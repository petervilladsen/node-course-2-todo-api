...
describe('POST /users', () => {
    ...
    it('Sould return validation errors if request invalid', (done) => {
        var email = 'donald@example';
        var password = 'pAss';
...
describe('POST /user/login', () => {
    ...
    it('Should reject invalid login', (done) => {
        request(app)
            ...
            .send({
                email: users[1].email,
                password: users[1].password + 'DonaldDuck'
            })
            .expect(400)
            .expect((res) => {
